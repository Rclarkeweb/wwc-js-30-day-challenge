...
const one = inventors.filter(year => (year.year >= 1500 && year.year <= 1600));
...
const two = inventors.map(name => `${name.first} ${name.last}`);
...
const six = people.sort((lastOne, nextOne) => {
